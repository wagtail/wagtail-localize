...
class TranslationRequestListView(ListView):
    template_name = 'wagtail_translation_workflow/management/list.html'
...
class TranslationRequestDetailView(DetailView):
    ...
    template_name = 'wagtail_translation_workflow/management/detail.html'
    permission_policy = None
    list_url_name = None
    detail_url_name = None
...
def copy_pages(request, translation_request_id):
    ...
    return redirect('wagtail_translation_workflow_management:detail', translation_request_id)
...
class CopyForTranslationView(DetailView):
    ...
    template_name = 'wagtail_translation_workflow/management/copy_for_translation.html'
    permission_policy = None
    list_url_name = None
    detail_url_name = None
    copy_for_translation_url_name = None
