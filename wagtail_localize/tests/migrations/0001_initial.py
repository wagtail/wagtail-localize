    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_customfield', wagtail_localize.tests.models.TestCustomField(blank=True)),
                ('locale', models.ForeignKey(default=wagtail_localize.models.default_locale_id, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='wagtail_localize.Locale')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='testpage',
            name='test_snippet',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='wagtail_localize_tests.TestSnippet'),
        ),
        migrations.AddField(
            model_name='testchildobject',
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_childobjects', to='wagtail_localize_tests.TestPage'),
        ),
