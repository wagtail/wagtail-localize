...
class SubmitToGoogleTranslateActionModule(BaseActionModule):
    template_name = 'wagtail_translation_google_translate/action_module.html'
...
def register_admin_urls():
    ...
    return [
        url('^translation/googletranslate/', include((urls, 'wagtail_translation_google_translate'), namespace='wagtail_translation_google_translate')),
    ]
