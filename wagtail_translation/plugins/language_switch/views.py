...
def translations_list(request, page_id):
    ...
    for translation in page.get_translations(inclusive=True).select_related('locale'):
        translations_by_region_unsorted[translation.locale.region_id].append(translation)
    ...
    return render_modal_workflow(request, 'wagtail_translation_language_switch/translation_list.html', None, {
        'page': page,
