...
from wagtail_translation.models import get_translatable_models, Locale, TranslatablePageMixin
...
def create_translation_request(request, page_id):
    ...
    return render(request, 'wagtail_translation_workflow/create_translation_request.html', {
        'page': page,
        'form': form,
    })
