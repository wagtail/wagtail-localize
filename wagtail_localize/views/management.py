...
class TranslationListView(ListView):
    template_name = "wagtail_localize/management/list.html"
...
class TranslationDetailView(DetailView):
    ...
    template_name = "wagtail_localize/management/detail.html"
    permission_policy = None
    list_url_name = None
    detail_url_name = None
    ...
    def get_context_data(self, object):
        ...
        if translator is not None and not translator.can_translate(object.source.locale, object.target_locale):
            translator = None
        context["machine"] = translator
