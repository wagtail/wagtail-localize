...
from wagtail_translation.bootstrap import bootstrap_translatable_model
from wagtail_translation.models import BootstrapTranslatableMixin, get_translatable_models
