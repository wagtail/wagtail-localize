...
class TestChildObject(TranslatableMixin, Orderable):
    page = ParentalKey("testpages.TestPage", related_name="test_childobjects")
    field = models.TextField()
...
class TestSynchronizedChildObject(Orderable):
    page = ParentalKey(
        "testpages.TestPage", related_name="test_synchronized_childobjects"
    )
    field = models.TextField()
...
class TranslatableChildObject(TranslatableMixin, Orderable):
    page = ParentalKey(
        "testpages.TestGenerateTranslatableFieldsPage",
...
class PageWithCustomEditHandlerChildObject(TranslatableMixin, Orderable):
    page = ParentalKey(
        "testpages.PageWithCustomEditHandler", related_name="child_objects"
    )
    field = models.TextField()
