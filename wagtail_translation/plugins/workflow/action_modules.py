...
class CopyPagesActionModule(BaseActionModule):
    template_name = 'wagtail_translation_workflow/action_modules/copy_pages.html'
...
def get_action_modules():
    ...
    for fn in hooks.get_hooks('wagtail_translation_workflow_register_action_modules'):
