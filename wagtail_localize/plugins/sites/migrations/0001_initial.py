    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(default=wagtail_localize.models.Region.default_id, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='wagtail_localize.Region', verbose_name='region')),
