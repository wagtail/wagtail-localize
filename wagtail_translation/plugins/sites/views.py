...
class IndexView(generic.IndexView):
    template_name = 'wagtail_translation_sites/index.html'
...
class CreateView(generic.CreateView):
    ...
    template_name = 'wagtail_translation_sites/create.html'
...
class EditView(generic.EditView):
    ...
    template_name = 'wagtail_translation_sites/edit.html'
