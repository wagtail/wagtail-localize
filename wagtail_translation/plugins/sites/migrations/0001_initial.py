    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(default=wagtail_translation.models.Region.default_id, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='wagtail_translation.Region', verbose_name='region')),
